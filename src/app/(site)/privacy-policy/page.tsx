...
export const metadata: Metadata = {
  ...
  description: 'Our privacy policy for software services',
};
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <section>
            ...
            <p className="text-gray-600">We collect information you provide directly to us, such as when you create an
              account, use our services,
          ...
          <section>
            ...
            <p className="text-gray-600">We use the information we collect to provide, maintain, and improve our
              services, to develop new ones,
              and to protect our company and our users. We may also use the information to communicate with you about
              our services, send you technical notices, updates, security alerts, and support messages.</p>
          </section>
          <Separator />
          <section>
            <h2 className="text-2xl font-medium mb-2">3. Information Sharing and Disclosure</h2>
            <p className="text-gray-600">We do not share personal information with companies, organizations, or
          ...
          <section>
            ...
            <p className="text-gray-600">We use appropriate technical and organizational measures to protect the
              ...
              to the risk of processing your personal information.</p>
          </section>
          <Separator />
          <section>
            <h2 className="text-2xl font-medium mb-2">5. Your Rights</h2>
            <p className="text-gray-600">You have the right to access, update, or delete your personal information. You
              ...
              portability of your personal information.</p>
          </section>
        </CardContent>
      </Card>
    </div>
